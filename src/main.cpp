...
void usercontrol(void) {
  ...
  while (1) {
    ...
    if(loadCatapault && !catapaultSwitch.pressing())
    {
      ...
      {
      leftCatapault.stop(brake);
      rightCatapault.stop(brake);
      leftCatapault.setStopping(hold);
      rightCatapault.setStopping(hold);
      }
    }
   else  if(catapaultSwitch.pressing())
    {
      leftCatapault.setStopping(brake);
      rightCatapault.setStopping(brake);
    //  leftCatapault.setStopping(hold);
     // rightCatapault.setStopping(hold);
      leftCatapault.stop();
      rightCatapault.stop();
